...
import com.alky.hifx.audio.MediaLibraryUiState
import com.alky.hifx.databinding.FragmentPlaybackBinding
...
class PlaybackFragment : Fragment() {
    ...
    private var currentPlayableTracks: List<com.alky.hifx.audio.LibraryTrack> = emptyList()
    ...
    private fun renderRows(state: MediaLibraryUiState) {
        ...
        val playableTracks: List<com.alky.hifx.audio.LibraryTrack>
        when (selectedTab) {
            LibraryTab.ALL -> {
    ...
    private fun buildSectionRows(sections: List<com.alky.hifx.audio.TrackSection>): List<LibraryListRow> {
    ...
    private fun filterSectionsByQuery(
        sections: List<com.alky.hifx.audio.TrackSection>,
        query: String
    ): List<com.alky.hifx.audio.TrackSection> {
        if (query.isBlank()) {
            return sections
        }
    ...
    private fun trackMatchesQuery(track: com.alky.hifx.audio.LibraryTrack, query: String): Boolean {
        if (query.isBlank()) {
            return true
        }
