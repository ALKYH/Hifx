...
import com.alky.hifx.databinding.ActivityMainBinding
import com.alky.hifx.databinding.LayoutMiniPlayerBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun navigateByItem(itemId: Int): Boolean {
        return when (itemId) {
            ...
            R.id.navigation_effects -> {
                navigateTo(com.alky.hifx.EffectsFragment(), R.string.page_effects, TAG_EFFECTS)
                true
            }
    ...
    private fun updateTopBarTitleFromCurrentFragment() {
        when (supportFragmentManager.findFragmentById(R.id.fragment_container)) {
            ...
            is com.alky.hifx.EffectsFragment -> setTopBarTitle(getString(R.string.page_effects))
